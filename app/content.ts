...
export const content = {
  en: {
    ...
    economics: {
      ...
      modelNote: "This saving is calculated by comparing Weso’s pay-per-use cost with the average per-capita payment insurers make to assistance companies.",
    ...
    team: {
      ...
      members: [
        ...
        ["Martin Baumann", "Head of Growth · Co-founder", "Chile", "/assets/martin-baumann-portrait.png"],
  ...
  es: {
    ...
    economics: {
      ...
      modelNote: "Este ahorro se obtiene comparando el costo por uso de Weso con el pago per cápita promedio que las aseguradoras hacen a las compañías de asistencia.",
    ...
    team: {
      ...
      members: [
        ...
        ["Martin Baumann", "Head of Growth · Cofundador", "Chile", "/assets/martin-baumann-portrait.png"],
